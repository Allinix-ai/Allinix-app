...
const AppHead = ({ title, ogTitle }: { title?: string; ogTitle?: string }) => {
  ...
  return (
    <Head>
      <title>{title ?? "Allinix"}</title>
      <meta name="description" content={description} />
      <meta name="twitter:site" content="@AllinixAI" />
      ...
      <meta property="og:title" content={ogTitle ?? "Allinix: Autonomous AI in your browser 🤖"} />
      <meta property="og:description" content={description} />
      <meta property="og:url" content="https://allinix.allinix.ai/" />
      <meta property="og:image" content="https://allinix.allinix.ai/banner.png" />
