...
export default function HelpDialog() {
  ...
  useEffect(() => {
    const key = "allinix-modal-opened-v0.2";
  ...
  return (
    ...
    >
      <div>
        <p>
          Allinix is the next generation of Google search. Ask any question and watch as an AI Agent
          gives you the perfect answer after aggregating relevant sources from across the internet.
        </p>
        <br />
        ...
        <div className="mt-4 flex w-full items-center justify-center gap-5">
          ...
          <div
            className="cursor-pointer rounded-full bg-slate-6 p-3 hover:bg-slate-8"
            onClick={() => window.open("https://github.com/allinix/Allinix", "_blank")}
          >
            <FaGithub size={30} />
          </div>
        </div>
