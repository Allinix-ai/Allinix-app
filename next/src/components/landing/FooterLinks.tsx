...
const FooterLinks = () => {
  return (
    <div className="hidden cursor-pointer flex-row justify-center space-x-4 lg:flex">
      <FooterLink href="https://www.ycombinator.com/companies/allinix/jobs">Careers</FooterLink>
      <FooterLink href="https://status.allinix.ai">
      ...
      <FooterLink href="https://allinix.allinix.ai/privacypolicy">Privacy</FooterLink>
      <FooterLink href="https://allinix.allinix.ai/terms">Terms</FooterLink>
    </div>
  );
};
