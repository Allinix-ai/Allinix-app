      ...
      <div className="flex flex-row">
          ...
          <Terminal className="absolute" title="index.ts">
            <pre className="overflow-x-hidden">
              {"" +
                ...
                "<html>\n" +
                "<head>\n" +
                " <title>My Allinix Website</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "  <h1>Welcome to Allinix!</h1>\n" +
                "  <p>Explore the power of autonomous AI agents.</p>\n" +
                '  <script src="https://allinix.allinix.ai/allinix.js"></script>\n' +
                "  <script>\n" +
                "    // Connect to Allinix API\n" +
                "    agent.connect('YOUR_API_KEY');\n" +
                "    \n" +
                "    // Example code to interact with Allinix\n" +
        ...
        <div className="mt-28 w-full">
          ...
          <div className="mt-6 flex flex-row gap-4">
            <a href="https://github.com/allinix" target="_blank">
              <PrimaryButton>View on Github</PrimaryButton>
            </a>
            <a href="https://github.com/orgs/allinix/projects/3" target="_blank">
