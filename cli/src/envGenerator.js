...
const getEnvDefinition = (envValues, isDockerCompose, dbPort, platformUrl) => {
  return {
    ...
    Backend: {
      ALLINIX_PLATFORM_ENVIRONMENT: "${NODE_ENV}",
      ALLINIX_PLATFORM_FF_MOCK_MODE_ENABLED: false,
      ALLINIX_PLATFORM_MAX_LOOPS: "${NEXT_PUBLIC_MAX_LOOPS}",
      ALLINIX_PLATFORM_OPENAI_API_KEY:
        envValues.OpenAIApiKey || '"<change me>"',
      ALLINIX_PLATFORM_FRONTEND_URL: "http://localhost:3000",
      ALLINIX_PLATFORM_RELOAD: true,
      ALLINIX_PLATFORM_OPENAI_API_BASE: "https://api.openai.com/v1",
      ALLINIX_PLATFORM_SERP_API_KEY: envValues.serpApiKey || '""',
      ALLINIX_PLATFORM_REPLICATE_API_KEY: envValues.replicateApiKey || '""',
    },
    "Database (Backend)": {
      ALLINIX_PLATFORM_DATABASE_USER: "allinix_platform",
      ALLINIX_PLATFORM_DATABASE_PASSWORD: "allinix_platform",
      ALLINIX_PLATFORM_DATABASE_HOST: "allinix_db",
      ALLINIX_PLATFORM_DATABASE_PORT: dbPort,
      ALLINIX_PLATFORM_DATABASE_NAME: "allinix_platform",
      ALLINIX_PLATFORM_DATABASE_URL:
        "mysql://${ALLINIX_PLATFORM_DATABASE_USER}:${ALLINIX_PLATFORM_DATABASE_PASSWORD}@${ALLINIX_PLATFORM_DATABASE_HOST}:${ALLINIX_PLATFORM_DATABASE_PORT}/${ALLINIX_PLATFORM_DATABASE_NAME}",
    },
    "Database (Frontend)": {
      DATABASE_USER: "allinix_platform",
      DATABASE_PASSWORD: "allinix_platform",
      DATABASE_HOST: "allinix_db",
      DATABASE_PORT: dbPort,
      DATABASE_NAME: "allinix_platform",
      DATABASE_URL:
