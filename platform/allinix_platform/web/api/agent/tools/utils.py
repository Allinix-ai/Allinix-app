...
def summarize(
    ...
    from allinix_platform.web.api.agent.prompts import summarize_prompt
...
def summarize_with_sources(
    ...
    from allinix_platform.web.api.agent.prompts import summarize_with_sources_prompt
...
def summarize_sid(
    ...
    from allinix_platform.web.api.agent.prompts import summarize_sid_prompt
