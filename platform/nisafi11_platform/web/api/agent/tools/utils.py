...
def summarize(
    ...
    from nisafi11_platform.web.api.agent.prompts import summarize_prompt
...
def summarize_with_sources(
    ...
    from nisafi11_platform.web.api.agent.prompts import summarize_with_sources_prompt
...
def summarize_sid(
    ...
    from nisafi11_platform.web.api.agent.prompts import summarize_sid_prompt
