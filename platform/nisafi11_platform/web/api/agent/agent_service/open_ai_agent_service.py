...
from nisafi11_platform.db.crud.oauth import OAuthCrud
from nisafi11_platform.schemas.agent import ModelSettings
from nisafi11_platform.schemas.user import UserBase
from nisafi11_platform.services.tokenizer.token_service import TokenService
from nisafi11_platform.web.api.agent.agent_service.agent_service import AgentService
from nisafi11_platform.web.api.agent.analysis import Analysis, AnalysisArguments
from nisafi11_platform.web.api.agent.helpers import (
    call_model_with_handling,
    openai_error_handler,
    parse_with_handling,
)
from nisafi11_platform.web.api.agent.model_factory import WrappedChatOpenAI
from nisafi11_platform.web.api.agent.prompts import (
    analyze_task_prompt,
    chat_prompt,
    create_tasks_prompt,
    start_goal_prompt,
)
from nisafi11_platform.web.api.agent.task_output_parser import TaskOutputParser
from nisafi11_platform.web.api.agent.tools.open_ai_function import get_tool_function
from nisafi11_platform.web.api.agent.tools.tools import (
    get_default_tool,
    get_tool_from_name,
    get_tool_name,
    get_user_tools,
)
from nisafi11_platform.web.api.agent.tools.utils import summarize
